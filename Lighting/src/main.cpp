...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        lightingShader.setFloat("brightness", brightnessValue);
        ...
        float timevar;
        timevar += (rotateSpeed * deltaTime);
        model = glm::rotate(model, glm::radians(20.0f * timevar), glm::vec3(1.0f, 0.3f, 0.5f));
